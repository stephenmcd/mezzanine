...
One approach to address this is to use the Django's
...
subclasses of the one you are injecting fields into. Missing to do so
would result in broken depencies for migration files.
