...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Field._order'
        db.alter_column(u'forms_field', '_order', self.gf('mezzanine.core.fields.OrderField')(null=True))

    def backwards(self, orm):

        # Changing field 'Field._order'
        db.alter_column(u'forms_field', '_order', self.gf('django.db.models.fields.IntegerField')(null=True))

    models = {
        u'forms.field': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'Field'},
            '_order': ('mezzanine.core.fields.OrderField', [], {'null': 'True'}),
        ...
        u'pages.page': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_menus': ('mezzanine.pages.fields.MenusField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
