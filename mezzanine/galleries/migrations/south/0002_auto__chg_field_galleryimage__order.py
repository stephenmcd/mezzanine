...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GalleryImage._order'
        db.alter_column(u'galleries_galleryimage', '_order', self.gf('mezzanine.core.fields.OrderField')(null=True))

    def backwards(self, orm):

        # Changing field 'GalleryImage._order'
        db.alter_column(u'galleries_galleryimage', '_order', self.gf('django.db.models.fields.IntegerField')(null=True))
