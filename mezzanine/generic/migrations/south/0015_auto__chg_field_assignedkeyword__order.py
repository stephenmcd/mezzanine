...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AssignedKeyword._order'
        db.alter_column(u'generic_assignedkeyword', '_order', self.gf('mezzanine.core.fields.OrderField')(null=True))

    def backwards(self, orm):

        # Changing field 'AssignedKeyword._order'
        db.alter_column(u'generic_assignedkeyword', '_order', self.gf('django.db.models.fields.IntegerField')(null=True))
