...
from mezzanine.core.admin import DisplayableAdmin, DisplayableAdminForm, need_translation
        ...
        if self.model is not Page and self.fieldsets == PageAdmin.fieldsets:
            ...
            for field in reversed(fields):
                if field.name not in exclude_fields and field.editable:
                    if need_translation and field.name.split('_')[-1] not in [code for code, _ in settings.LANGUAGES]:
