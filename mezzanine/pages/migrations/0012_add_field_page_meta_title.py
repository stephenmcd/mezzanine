...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('pages_page', 'meta_title', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)
        db.add_column('pages_page', 'add_title_suffix', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

    def backwards(self, orm):
        db.delete_column('pages_page', 'meta_title')
        db.delete_column('pages_page', 'add_title_suffix')
